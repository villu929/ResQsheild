...
void main() async {
  final content = (await File(r'c:\Users\vishal\Downloads\ResQsheild-main\ResQsheild-main\test\recovered_latest.dart').readAsString()).replaceAll('\r\n', '\n');
