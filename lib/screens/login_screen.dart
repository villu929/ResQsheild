...
class _LoginScreenState extends State<LoginScreen>
  ...
  void _validateLogin() {
    ...
    // but the password must be the configured demo password.
    final isValid = (isEmail || isPhone) && password == 'ResQsheild';
      ...
      body: SafeArea(
        child: LayoutBuilder(
          builder: (context, constraints) {
            ...
            final responsiveWidth = (availableWidth - horizontalPadding * 2)
                .clamp(280.0, 430.0);
            ...
            return SingleChildScrollView(
              ...
              child: Stack(
                children: [
                  // ==========================================================
                  // OCEAN BACKGROUND
                  // Now lives INSIDE the scrolling content instead of being
                  // fixed behind it — so it scrolls together with the logo,
                  // textfields, and everything else. The sun (painted near
                  // the top of this tile) scrolls up and disappears just
                  // like the header does. Past this one screen-tall painted
                  // tile, the Scaffold's own backgroundColor (matched to the
                  // painter's deepest water tone) continues seamlessly, so
                  // there's no visible seam as you keep scrolling.
                  // ==========================================================
                  Positioned(
                    top: 0,
                    left: 0,
                        ...
                        child: SizedBox(
                          ...
                          child: Column(
                            children: [
                              ...
                              Text(
                                'Protecting Water, Protecting Lives',
                                style: TextStyle(
